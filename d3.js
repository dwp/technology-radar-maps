d3 = function() {
  ...
  d3.scale.categorytechradar = function() {
    return d3.scale.ordinal().range(d3_categorytechradar);
  };
  ...
  var d3_categorytechradar = [ 14034728,16744206, 2924588, 14907330, 2062260,16777215,8355711 ].map(d3_rgbString);
